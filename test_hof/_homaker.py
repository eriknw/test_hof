...
class HofModule(BaseHofModule):
    ...
    def __init__(self, name, source, doc=''):
        super(HofModule, self).__init__(name, source)
...
class FirstHofModule(BaseHofModule):
    ...
    def __init__(self, name, source, fofs, hofs, doc='', reverse=False,
        ...
        for item in self._hofs:
            setattr(self, item, HofModule(item, self))
...
def create_higher_order_module(source_module, module_name, fofs, hofs,
    ...
    hof_module = FirstHofModule(module_name, source_module, fofs, hofs,
